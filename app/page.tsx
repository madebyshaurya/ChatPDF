...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-white dark:bg-black">
      <div className="py-24 sm:py-32 rounded-md">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-black dark:text-white sm:text-6xl">
          ...
          <Button asChild className="mt-10 w-36 group relative">
            <Link
              href="/dashboard"
            ...
            >
              ...
              <span className="relative w-5 h-5">
                <ChevronRight
                  size={20}
                  className="absolute inset-0 transition-all duration-200 group-hover:opacity-0 group-hover:translate-x-1"
                />
                <ArrowRight
                  size={20}
                  className="absolute inset-0 transition-all duration-200 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0"
                />
              </span>
            </Link>
          </Button>
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div aria-hidden="true" className="relative">
              <div className="absolute bottom-0 -inset-x-32 bg-gradient-to-t from-white dark:from-black pt-[5%]" />
            </div>
          </div>
        </div>
